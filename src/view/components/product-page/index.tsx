...
export const ProductPage: FC = () => {
  ...
  const {isLoading: isProductLoading, error: productError, data: product} = useFetchProduct(productId)
  const {isLoading: isLinkedProductsLoading, error: linkedProductsError, data: linkedProducts} = useFetchLinkedProducts(productId)
